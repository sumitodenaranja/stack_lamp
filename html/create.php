...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO tbpueblosmalaga (SimboloQuimico, NombreLocalidad, Comarca, AlturaNivelMar, Habitantes, Superficie, NumeroElementoQuimico)
            VALUES ('$simboloQuimico', '$nombreLocalidad', '$comarca', '$alturaNivelMar', '$habitantes', '$superficie', '$numeroElementoQuimico')";
...
<body>
    ...
    <div class="container">
        ...
        <p>Ingresa los detalles del nuevo pueblo o localidad para agregarlo a la base de datos.</p>
